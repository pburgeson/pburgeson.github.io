...
# Velocity SE
Efforts to rebuild a Velocity SE into an outstanding cross country aircraft.
...
![Cherokee in FL](/img/SGI_Cherokee.jpg)
...
![Velocity on Truck](/img/Velocity_On_Truck.jpeg)

## Current Status
As of May, 2026, the aircraft is in pieces in a storage unit.  Work is centered around developing the storage unit into a better workspace and getting the aircraft into a more stable condition.  Refer to [my blog](/blog) for the details.

## Major Work to Be Completed:
* Thorough inspection of airframe and all aircraft systems
* Sourcing and potentially overhauling engine
* Installation of engine and firewall forward work
* Sourcing and installation of prop
* Reinstallation and testing of avionics
* Addition of lower hatch door
* Completion of interior
* Reassembly of aircraft and control systems
* Flight testing